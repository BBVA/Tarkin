...
TEST_METRICS_FILE = "security-anomalies-logs-data/metrics/check-test-metrics.txt"

SENTI_DIC = "security-anomalies-logs-data/data/vocab/SentiWordNet_3.0.0_20130122.txt"
LETTER_SPACE = "security-anomalies-logs-data/input-data/letterspace.pkl"
